defmodule Explode do
  ...
  @json_encoder Application.get_env(:explode, :json_library, Poison)
  ...
  defp build_body(status_code, error, nil, content_type),
    do: build_body(status_code, error, error, content_type)
  ...
  defp do_reply(conn, code, payload, content_type) do
    ...
    |> Plug.Conn.send_resp(code, @json_encoder.encode!(payload))
    |> Plug.Conn.halt()
  end
